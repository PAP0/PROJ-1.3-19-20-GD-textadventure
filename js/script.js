...
descriptions[2] = ["u heeft gewonnen", "", "", "barack-obama"];
descriptions[3] = ["u staat in de lerarenkamer. De leraren eten hier hun lunch of drinken koffie of thee", "an-apple", "apple.png", ""];
descriptions[4] = ["u staat in een gang. Studenten en leraren lopen richting de klaslokalen", "", "", ""];
descriptions[5] = ["u staat in het medialab. Hier kan geexperimenteerd worden met bijvoorbeeld virtual reality brillen", "barack-obama", "oabma.png", ""];
descriptions[6] = ["u staat bij de toiletten", "", "", ""];
descriptions[7] = ["u staat in een klaslokaal. De tafels staan recht achter elkaar en voorin is een projector en een smartboard", "a-hamster", "hamster.png", ""];
